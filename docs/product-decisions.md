...
- `Junlaii/Bro-ASR-1.7B`: Qwen3-ASR-1.7B-hf 기반 noisy Japanese full-merged safetensors 후보. Exact revision `6e8f651ad6137457a2a6e813b810349a7e272f4b`와 official Transformers exact commit runtime만 사용한다. 2026-08-30 external runtime 정적 보안 검토는 `PASS_WITH_CONSTRAINTS`이며, persistent snapshot `.casrt/models/bro-asr-1.7b-6e8f651ad6137457a2a6e813b810349a7e272f4b`은 preflight를 통과했다. Snapshot digest는 `12d96810a8d5146f7da52d50c8c9576ea76d84cc56d65aca95e95e5c377fd565`다. Pinned chat template hash, offline/local-only/network block, persistent digest/runtime provenance를 유지하고 official Qwen HF base와 같은 beam 5/all8 조건으로 비교한다. 실데이터 gate 전에는 기본 승격하지 않는다.
