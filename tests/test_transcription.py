...
class TranscriptionAdapterTests(unittest.TestCase):
    ...
    def test_worker_client_can_use_scrubbed_offline_env(self):
        ...
        self.assertEqual(worker_env["CASRT_TRANSFORMERS_DISABLE_NETWORK"], "1")
        self.assertEqual(worker_env["CASRT_TRANSFORMERS_LOCAL_FILES_ONLY"], "1")
        self.assertEqual(worker_env["CASRT_TRANSFORMERS_REQUIRE_LOCAL_MODEL_PATH"], "1")
