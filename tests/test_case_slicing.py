...
class CaseSlicingTests(unittest.TestCase):
    def test_clipping_invalidates_review_evidence_but_full_segment_preserves_it(self):
        ...
        self.assertFalse(sliced.segments[0].content_reviewed)
        self.assertTrue(sliced.segments[0].needs_review)
        self.assertTrue(sliced.segments[1].channel_reviewed)
        self.assertTrue(sliced.segments[1].content_reviewed)
